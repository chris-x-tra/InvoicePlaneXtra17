...
-->
                <li><?php echo anchor('employee/timesheets/index', trans('worktime_overview')); ?></li>
                <li><?php echo anchor('employee/timesheets/form', trans('workhours_enter')); ?></li>
            </ul>
...
<div>
    <div class="sidebar hidden-xs <?php if (get_setting('disable_sidebar') == 1) {
        ...
        <ul>
            <li>
                <a href="<?php echo site_url('employee'); ?>" title="<?php _trans('dashboard'); ?>" class="tip"
                   data-placement="right">
                    <i class="fa fa-dashboard"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('employee/clients/index'); ?>" title="<?php _trans('quotes'); ?>"
                   class="tip"
                   data-placement="right">
