...
class Mdl_User_Clients extends MY_Model
{
    ...
    {
        $this->db->select(
      'CONCAT(ip_clients.client_name, " ", ip_clients.client_surname) as client_fullname, '
	  ." ip_user_clients.*, "
	  ." ip_users.user_name, "
      ." ip_clients.*, "
      ." ip_client_extended.*" );
    ...
    public function default_join()
    {
        ...
        $this->db->join('ip_client_extended', 'ip_client_extended.client_id = ip_clients.client_id');
    }
