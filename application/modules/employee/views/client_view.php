<script>
    $(function () {
        $('#save_client_note').click(function () {
            $.post('<?php echo site_url('employee/ajax/save_client_note'); ?>',
                {
                    ...
                    if (response.success === 1) {
                        ...
                        // Reload all notes
                        $('#notes_list').load("<?php echo site_url('employee/ajax/load_client_notes'); ?>",
                            {
...
<div id="headerbar">
    ...
    <div class="headerbar-item pull-right">
        <div class="btn-group btn-group-sm">
            <a href="<?php echo site_url('employee/clients/upload_document/' . $client->client_id); ?>" class="btn btn-default client-upload-document"
...
<ul id="submenu" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li><a data-toggle="tab" href="#clientDocuments"><?php _trans('documents'); ?></a></li>
</ul>
...
<p><?php _trans('birthdate'); ?>:&nbsp;
<?php echo format_date($client->client_birthdate); ?>
</p>
<p><?php _trans('customer_insurance_number'); ?>:&nbsp;
<?php _xpr($client,'customer_insurance_number'); ?>
</p>
<p>
Paragraphen:&nbsp;
...
<br />
1) Stundenweise Verhinderungspflege §39b SGb XI total in <?php  echo $year; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_1_total); ?>
</td>
</tr>

<tr>
<th style="text-align: right;">
2) Entlastungshilfe nach §45b SGb XI total in <?php  echo $year; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_2_total); ?>
</td>
</tr>
<tr>
<th style="text-align: right;">
3) Entlastungshilfe nach §45a SGb XI mit Umwidmung in <?php echo $year; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_3_total); ?>
</td>
</tr>

<tr>
<th style="text-align: right;">
Rechnungen, in denen beides 2 und 3 kombiniert ist in <?php echo $year; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_23_total); ?>
</td>
</tr>
...
<tr>
<th style="text-align: right;">
Verbrauchtes Budget nach Paragraph in <?php echo $year-1; ?>
<br />
1) Stundenweise Verhinderungspflege §39b SGb XI total in <?php  echo $year-1; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_1_total_old); ?>
</td>
</tr>

<tr>
<th style="text-align: right;">
2) Entlastungshilfe nach §45b SGb XI total in <?php  echo $year-1; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_2_total_old); ?>
</td>
</tr>

<tr>
<th style="text-align: right;">
3) Entlastungshilfe nach §45a SGb XI mit Umwidmung in <?php echo $year-1; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_3_total_old); ?>
</td>
</tr>

<tr>
<th style="text-align: right;">
Rechnungen, in denen beides 2 und 3 kombiniert ist in <?php echo $year-1; ?>
</th>
<td class="td-amount">
<?php echo format_currency($type_23_total_old); ?>
</td>
</tr>
</table>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="panel panel-default no-margin">
                        ...
                        <div class="panel-heading"><?php _trans('additional_information'); ?></div>
                        <div class="panel-body table-content" >
